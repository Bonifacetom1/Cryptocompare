...
import com.example.tomboniface.cryptocompare.Adapter.AdapterBTC;
import com.example.tomboniface.cryptocompare.ApiService.BtcApiService;
...
public class ActivityBTC extends AppCompatActivity implements Callback<ConversionBTC>, BtcItem{
    ...
    public void onBTCCurrencyItemClick(ModelBTC btcCoinModel) {
        Intent myIntent = new Intent(this, BtcToCurrency.class);
