...
import com.example.tomboniface.cryptocompare.Adapter.AdapterETH;
import com.example.tomboniface.cryptocompare.ApiService.EthCoinApiService;
import com.example.tomboniface.cryptocompare.ApiService.EthItem;
...
public class ActivityETH extends AppCompatActivity implements Callback<ConversionETH>, EthItem{
    ...
    public void onETHCurrencyItemClick(ModelETH ethCoinModel) {
        Intent myIntent = new Intent(this, EthToCurrency.class);
